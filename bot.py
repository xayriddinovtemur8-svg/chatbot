...
COINS_PER_MSG  = 5
COINS_STANDARD = 100000000
COINS_PREMIUM  = 1000000000
AFFILIATE_PCT  = 25
MAX_WARNINGS   = 10
...
"help": (
    ...
    "🌤 *Real-time:*\n"
    "/weather /crypto /news\n\n"
    "💰 /updateplan • 🪙 /coins • 👥 /referral\n"
    "🤝 /affiliate • 🎁 /gift • 🏆 /top • 📊 /stats\n"
    "🎟️ /promo • 🌐 /language • 🗑️ /reset\n\n"
    "⭐ Standard+ • 💎 Premium only"
),
"plan_free":"🆓 FREE","plan_standard":"⭐ STANDARD","plan_premium":"💎 PREMIUM","plan_admin":"👑 ADMIN",
...
"creating_pptx":"⏳ Creating *{t}*...","creating_word":"⏳ Creating *{t}*...",
"ready":"✅ Ready!",
...
"claimed_std":"🎉 ⭐ *Standard* for 15 days!",
"claimed_prm":"🎉 💎 *Premium* for 15 days!",
"claim_err":"❌ Already claimed or not enough referrals!",
"aff_info":(
    "🤝 *Affiliate Program*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "🔗 *Your link:*\n`{link}`\n\n"
    "📊 Referrals: {count} | 🪙 Earned: {earned:,} coins\n\n"
    "Share your link — earn *{aff}%* of their coins!"
),
"stats_info":(
    "📊 *Statistics*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "{pe} *{plan}* | 📅 {exp}\n"
...
"banned":"🚫 Banned for repeated abuse.",
"achievement":"🏆 *100,000 messages!*\n⭐ Standard for 5 days!",
"updateplan_txt":(
    "💰 *Plans & Pricing*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "🆓 *FREE* — Chat 20/d • Search 20/d • Translate • Code\n\n"
    "⭐ *STANDARD — {us} USDT / {ss}⭐ / {cs:,}🪙*\n"
    "Everything 30/d + PDF • CV • Email • Voice • Document\n\n"
    "💎 *PREMIUM — {up} USDT / {sp}⭐ / {cp:,}🪙*\n"
    "Everything Unlimited + AI Image • PowerPoint • Word\n\n"
    "👥 *GROUP — {sg}⭐ ($111.11)* — Bot for your group\n\n"
    "━━━━━━━━━━━━━━━━━━━━\n"
    "{pe} *{plan}* | 📅 {exp} | 🪙 {coins:,}"
),
"pay_card":"💳 *Card:*\n`{card}`\n\n💵 *{amt} USDT*\n\n1. Screenshot → 2. @{admin} → 3. Activated in 1h ✅",
...
"btn_contact":"💬 Contact Admin","btn_img":f"🎨 Pay {STARS_IMAGINE}⭐ per image",
},
...
"plan_free":"🆓 BEPUL","plan_standard":"⭐ STANDART","plan_premium":"💎 PREMIUM","plan_admin":"👑 ADMIN",
...
"lang_changed":"✅ Til *O'zbek*chaga o'zgartirildi!",
...
"claim_std":"🎁 Standart 15 kun","claim_prm":"🎁 Premium 15 kun",
...
"aff_info":(
    "🤝 *Affiliate Dasturi*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "🔗 *Sizning havola:*\n`{link}`\n\n"
    "📊 Referallar: {count} | 🪙 Ishlangan: {earned:,}\n\n"
    "Havolangizni ulashing — coinlarning *{aff}%*ini olasiz!"
),
"stats_info":(
    "📊 *Statistika*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "{pe} *{plan}* | 📅 {exp}\n"
...
"promo_ok":"✅ Promo qo'llandi! *{reward}*",
"group_info":(
...
"warning":"⚠️ *Ogohlantirish {c}/{m}:* Hurmat bilan muomala qiling!",
"banned":"🚫 Qayta haqorat qilgani uchun bloklandi.",
"achievement":"🏆 *100,000 xabar!*\n⭐ Standart 5 kunga yoqildi!",
"updateplan_txt":(
    "💰 *Tariflar va Narxlar*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "🆓 *BEPUL* — Suhbat 20/k • Qidiruv • Tarjima • Kod\n\n"
    "⭐ *STANDART — {us}$ / {ss}⭐ / {cs:,}🪙*\n"
    "Hammasi 30/k + PDF • CV • Email • Ovoz • Hujjat\n\n"
    "💎 *PREMIUM — {up}$ / {sp}⭐ / {cp:,}🪙*\n"
    "Hammasi Cheksiz + AI Rasm • PowerPoint • Word\n\n"
    "👥 *GURUH — {sg}⭐ ($111.11)* — Guruh uchun bot\n\n"
    "━━━━━━━━━━━━━━━━━━━━\n"
    "{pe} *{plan}* | 📅 {exp} | 🪙 {coins:,}"
),
"pay_card":"💳 *Karta:*\n`{card}`\n\n💵 *{amt} USDT*\n\n1. Skrinshot → 2. @{admin} → 3. 1 soatda yoqiladi ✅",
...
"btn_contact":"💬 Admin bilan bog'lanish","btn_img":f"🎨 {STARS_IMAGINE}⭐ to'lab rasm",
},
...
"plan_free":"🆓 БЕСПЛАТНО","plan_standard":"⭐ STANDARD","plan_premium":"💎 PREMIUM","plan_admin":"👑 ADMIN",
...
"creating_pptx":"⏳ Создаю *{t}*...","creating_word":"⏳ Создаю *{t}*...",
"ready":"✅ Готово!",
...
"coins_info":(
    "🪙 *Монеты: {coins:,}*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "📈 *Заработать:*\n• +{cpm} за сообщение\n• +{aff}% с рефералов\n• +25 бонус (/gift)\n\n"
    "🛒 *Потратить:*\n• {std:,} = ⭐ Standard 30 дней\n• {prm:,} = 💎 Premium 30 дней"
),
"not_enough":"❌ Нужно ещё *{need:,}* монет.",
"coins_ok_std":"✅ *Standard* на 30 дней! 🎉",
"coins_ok_prm":"✅ *Premium* на 30 дней! 🎉",
"referral_info":(
...
"claim_std":"🎁 Standard 15 дней","claim_prm":"🎁 Premium 15 дней",
"claimed_std":"🎉 ⭐ *Standard* на 15 дней!",
"claimed_prm":"🎉 💎 *Premium* на 15 дней!",
"claim_err":"❌ Уже получено или недостаточно!",
"aff_info":(
    "🤝 *Аффилиат Программа*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "🔗 *Ваша ссылка:*\n`{link}`\n\n"
    "📊 Рефералов: {count} | 🪙 Заработано: {earned:,}\n\n"
...
"updateplan_txt":(
    "💰 *Тарифы и Цены*\n━━━━━━━━━━━━━━━━━━━━\n\n"
    "🆓 *БЕСПЛАТНО* — Чат 20/д • Поиск • Перевод • Код\n\n"
    "⭐ *STANDARD — {us}$ / {ss}⭐ / {cs:,}🪙*\n"
    "Всё 30/д + PDF • CV • Email • Голос • Документ\n\n"
    "💎 *PREMIUM — {up}$ / {sp}⭐ / {cp:,}🪙*\n"
    "Всё Безлимитно + AI Фото • PowerPoint • Word\n\n"
    "👥 *ГРУППА — {sg}⭐ ($111.11)* — Бот для группы\n\n"
    "━━━━━━━━━━━━━━━━━━━━\n"
    "{pe} *{plan}* | 📅 {exp} | 🪙 {coins:,}"
),
        ...
        if row:
            ...
            if ref:
                ...
                try:
                    ...
                    c2.connection.commit(); c2.connection.close()
                except: pass
            return total
        return 0
    except: return 0
...
def get_limits(plan, is_admin=False):
    ALL={k:-1 for k in ["chat","search","image","post","biznes","pdf","cv","email","voice","pptx","word","tts","imagine","translate","code","document"]}
...
def plan_info(u):
    lang=u["language"]
    if u["is_admin"]: return "👑", t(lang,"plan_admin")
    p=u["plan"]
...
async def ai_chat(uid, text, do_search=False, limits=None):
    ...
    if mem and (mem.get("name") or mem.get("facts")):
        mc=f"User: name={mem['name']}, facts={mem['facts']}. "
    sys_p=(
        "You are ChatBot Pro — a professional, helpful AI assistant. "
        "CRITICAL: Always reply in the EXACT same language as the user's current message. "
        "Uzbek→Uzbek, English→English, Russian→Russian. "
        "If user asks to switch language, switch immediately. "
        "If asked who created you or who is your owner → say: 'My creator is @temur_uzb7779'. "
    ...
    if do_search and limits and limits.get("search")!= 0:
        if any(k in text.lower() for k in SEARCH_KEYWORDS):
            content=f"{text}\n[Answer with your best knowledge about current events/prices]"
    user_histories[uid].append({"role":"user","content":content})
    r=groq_client.chat.completions.create(model="llama-3.3-70b-versatile",messages=user_histories[uid])
...
def get_weather(city):
    try:
        ...
        em={"Clear":"☀️","Clouds":"☁️","Rain":"🌧️","Snow":"❄️","Thunderstorm":"⛈️","Drizzle":"🌦️","Mist":"🌫️","Fog":"🌫️"}.get(w["main"],"🌤")
...
def get_crypto(coin):
    try:
        ...
        mc=md["market_cap"]["usd"]; vol=md["total_volume"]["usd"]
...
def get_news():
    try:
        r=groq_client.chat.completions.create(model="llama-3.3-70b-versatile",messages=[{"role":"user","content":"Give 5 important world news headlines with brief descriptions. Format: 📌 **Title**\nDescription\n"}])
        return r.choices[0].message.content
    except: return None
...
def make_pptx(title, slides):
    ...
    for s in slides:
        ...
        for i,pt in enumerate(s["points"]):
            ...
            p.text=f"▸ {pt}"
            p.font.color.rgb=RGBColor(0xCD,0xD6,0xF4); p.font.size=Pt(18)
...
async def start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    pe,pn=plan_info(u)
    await update.message.reply_text(t(lang,"welcome",bot=BOT_NAME,pe=pe,plan=pn,coins=u["coins"]),parse_mode="Markdown")

async def help_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    user=update.effective_user
    ensure_user(user.id,user.username,user.full_name)
    u=get_user(user.id)
    await update.message.reply_text(t(u["language"],"help"),parse_mode="Markdown")
...
async def reset_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(t(u["language"],"cleared"),parse_mode="Markdown")
...
async def weather_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not city: await update.message.reply_text(t(lang,"ex_weather"),parse_mode="Markdown"); return
    result=get_weather(city)
    await update.message.reply_text(result if result else t(lang,"weather_err"),parse_mode="Markdown")
...
async def crypto_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not coin: await update.message.reply_text(t(lang,"ex_crypto"),parse_mode="Markdown"); return
    result=get_crypto(coin)
    await update.message.reply_text(result if result else t(lang,"crypto_err"),parse_mode="Markdown")
...
async def news_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    result=get_news()
    if result: await update.message.reply_text(f"📰 *Latest News*\n━━━━━━━━━━━━━━━━━━━━\n\n{result}",parse_mode="Markdown")
    else: await update.message.reply_text("❌ Could not fetch news.")
...
async def language_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if lca and datetime.now()-lca<timedelta(hours=24):
        await update.message.reply_text(t(lang,"lang_cooldown"),parse_mode="Markdown"); return
    kb=[]; row=[]
    for code,(flag,name) in LANGUAGES.items():
        row.append(InlineKeyboardButton(f"{flag} {name}",callback_data=f"lang_{code}"))
        if len(row)==2: kb.append(row); row=[]
    if row: kb.append(row)
    await update.message.reply_text(t(lang,"choose_lang"),reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown")
...
async def updateplan_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    kb=[
        [InlineKeyboardButton(t(lang,"btn_ss"),callback_data="stars_std"),
         InlineKeyboardButton(t(lang,"btn_ps"),callback_data="stars_prm")],
        [InlineKeyboardButton(t(lang,"btn_sc"),callback_data="coins_std"),
         InlineKeyboardButton(t(lang,"btn_pc"),callback_data="coins_prm")],
        [InlineKeyboardButton(t(lang,"btn_su"),callback_data="card_std"),
         InlineKeyboardButton(t(lang,"btn_pu"),callback_data="card_prm")],
        [InlineKeyboardButton(t(lang,"btn_grp"),callback_data="stars_grp")],
    ]
    await update.message.reply_text(
        t(lang,"updateplan_txt",us=USDT_STANDARD,ss=STARS_STANDARD,cs=COINS_STANDARD,
...
async def coins_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    u=get_user(user.id); lang=u["language"]
    kb=[]
    if u["coins"]>=COINS_STANDARD: kb.append([InlineKeyboardButton(t(lang,"btn_sc"),callback_data="coins_std")])
    if u["coins"]>=COINS_PREMIUM: kb.append([InlineKeyboardButton(t(lang,"btn_pc"),callback_data="coins_prm")])
    await update.message.reply_text(
        t(lang,"coins_info",coins=u["coins"],cpm=COINS_PER_MSG,aff=AFFILIATE_PCT,std=COINS_STANDARD,prm=COINS_PREMIUM),
...
async def referral_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    kb=[]
    if count>=10 and not u["claimed_standard"]: kb.append([InlineKeyboardButton(t(lang,"claim_std"),callback_data="claim_std")])
    if count>=30 and not u["claimed_premium"]: kb.append([InlineKeyboardButton(t(lang,"claim_prm"),callback_data="claim_prm")])
    await update.message.reply_text(
        t(lang,"referral_info",link=link,count=count,ss=ss,ps=ps,aff=AFFILIATE_PCT),
        reply_markup=InlineKeyboardMarkup(kb) if kb else None,parse_mode="Markdown")
...
async def affiliate_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        t(lang,"aff_info",link=link,count=u["referral_count"],earned=u["affiliate_earnings"],aff=AFFILIATE_PCT),
        parse_mode="Markdown")
...
async def gift_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if u["last_gift_claim"] and u["last_gift_claim"]>=today:
        await update.message.reply_text(t(lang,"gift_done"),parse_mode="Markdown"); return
    streak=u["streak_count"]
    streak=streak+1 if(u["last_gift_claim"] and(today-u["last_gift_claim"]).days==1) else 1
    try:
        conn=db(); c=conn.cursor()
        c.execute("UPDATE users SET streak_count=%s,last_gift_claim=%s,usage_chat=usage_chat+5,coins=coins+25 WHERE user_id=%s",(streak,today,user.id))
        conn.commit(); conn.close()
    except: pass
    if streak>=10 and not u["streak_claimed"]:
        ...
        await update.message.reply_text(t(lang,"gift_streak"),parse_mode="Markdown")
    else:
        await update.message.reply_text(t(lang,"gift_ok",streak=streak),parse_mode="Markdown")
...
async def stats_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        pe,pn=plan_info(u); exp=exp_str(u)
        await update.message.reply_text(
            t(lang,"stats_info",pe=pe,plan=pn,exp=exp,coins=u["coins"],
...
async def promo_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    ensure_user(user.id,user.username,user.full_name)
    u=get_user(user.id); lang=u["language"]
    if not ctx.args: await update.message.reply_text(t(lang,"promo_enter"),parse_mode="Markdown"); return
    ...
    try:
        ...
        promo=c.fetchone()
        if not promo: await update.message.reply_text(t(lang,"promo_bad"),parse_mode="Markdown"); conn.close(); return
        rtype,rval,maxu,used,exp=promo
        if(exp and datetime.now()>exp) or used>=maxu:
            await update.message.reply_text(t(lang,"promo_bad"),parse_mode="Markdown"); conn.close(); return
        c.execute("SELECT 1 FROM promo_uses WHERE user_id=%s AND code=%s",(user.id,code))
        if c.fetchone(): await update.message.reply_text(t(lang,"promo_used"),parse_mode="Markdown"); conn.close(); return
        ...
        await update.message.reply_text(t(lang,"promo_ok",reward=reward),parse_mode="Markdown")
    except Exception as e: await update.message.reply_text(f"Error: {e}")
...
async def createpromo_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if len(ctx.args)<3:
        await update.message.reply_text(
            "📋 *Create Promo Code*\n\nUsage:\n`/createpromo [type] [value] [max_uses] [optional_code]`\n\n"
    ...
    try:
        ...
        await update.message.reply_text(
            ...
            f"👥 Max uses: *{maxu}*\n"
            f"⏰ Expires: 30 days\n\n"
            f"Share this code with users!",parse_mode="Markdown")
    except Exception as e: await update.message.reply_text(f"Error: {e}")
...
async def group_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    ensure_user(user.id,user.username,user.full_name)
    u=get_user(user.id); lang=u["language"]
    kb=[[InlineKeyboardButton(t(lang,"btn_grp"),callback_data="stars_grp")]]
    await update.message.reply_text(t(lang,"group_info",s=STARS_GROUP),reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown")
...
async def activate_group_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(t(lang,"group_ok"),parse_mode="Markdown")
...
async def imagine_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not prompt: await update.message.reply_text(t(lang,"ex_imagine"),parse_mode="Markdown"); return
    if limits["imagine"]==0:
        kb=[[InlineKeyboardButton(t(lang,"btn_uprm"),callback_data="card_prm")],
            [InlineKeyboardButton(t(lang,"btn_img"),callback_data=f"img_pay_{prompt[:50]}")]]
        await update.message.reply_text(t(lang,"locked_img",s=STARS_IMAGINE),reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown"); return
    if not check_limit(user.id,"imagine",limits["imagine"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"gen_image"),parse_mode="Markdown")
...
async def translate_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not check_limit(user.id,"translate",limits["translate"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    text=" ".join(ctx.args)
    if not text: await update.message.reply_text(t(lang,"ex_translate"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"translating"),parse_mode="Markdown")
    try:
...
async def code_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not check_limit(user.id,"code",limits["code"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    text=" ".join(ctx.args)
    if not text: await update.message.reply_text(t(lang,"ex_code"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"writing_code"),parse_mode="Markdown")
    try:
...
async def document_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if limits["document"]==0:
        kb=[[InlineKeyboardButton(t(lang,"btn_ustd"),callback_data="card_std")]]
        await update.message.reply_text(t(lang,"locked_std"),reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown"); return
    if not check_limit(user.id,"document",limits["document"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    text=" ".join(ctx.args)
    if not text: await update.message.reply_text(t(lang,"ex_document"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"writing_doc"),parse_mode="Markdown")
    try:
...
async def ai_sound_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not check_limit(user.id,"tts",limits["tts"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    text=" ".join(ctx.args)
    if not text: await update.message.reply_text(t(lang,"ex_voice"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"gen_voice"),parse_mode="Markdown")
    try:
...
async def pptx_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if limits["pptx"]==0:
        kb=[[InlineKeyboardButton(t(lang,"btn_uprm"),callback_data="card_prm")]]
        await update.message.reply_text(t(lang,"locked_prm"),reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown"); return
    topic=" ".join(ctx.args)
    if not topic: await update.message.reply_text(t(lang,"ex_pptx"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"creating_pptx",t_=topic).replace("t_=",""),parse_mode="Markdown")
    try:
...
Min 6 slides. Same language as topic.""")
        ...
        with open(path,"rb") as f:
            await update.message.reply_document(f,filename=f"{topic}.pptx",caption=t(lang,"ready"))
        os.remove(path)
    except Exception as e: await update.message.reply_text(f"Error: {e}")
...
async def word_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if limits["word"]==0:
        ...
        await update.message.reply_text(t(lang,"locked_prm"),reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown"); return
    topic=" ".join(ctx.args)
    if not topic: await update.message.reply_text(t(lang,"ex_word"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"creating_word",t_=topic).replace("t_=",""),parse_mode="Markdown")
    try:
        raw=await ai_once(f"""Create Word document for: '{topic}'. Reply ONLY valid JSON:
{{"title":"...", "sections":[{{"title":"...", "points":["...","...","..."]}}]}}
Min 5 sections. Same language as topic.""")
        raw=raw.strip()
        if "```" in raw: raw=raw.split("```")[1]; raw=raw[4:] if raw.startswith("json") else raw
        data=json.loads(raw)
        path=make_docx(data["title"],data["sections"])
        with open(path,"rb") as f:
            await update.message.reply_document(f,filename=f"{topic}.docx",caption=t(lang,"ready"))
        os.remove(path)
    except Exception as e: await update.message.reply_text(f"Error: {e}")
...
async def cv_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not check_limit(user.id,"cv",limits["cv"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    info=" ".join(ctx.args)
    if not info: await update.message.reply_text(t(lang,"ex_cv"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"writing_cv"),parse_mode="Markdown")
    try:
...
async def email_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not check_limit(user.id,"email",limits["email"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    topic=" ".join(ctx.args)
    if not topic: await update.message.reply_text(t(lang,"ex_email"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"writing_email"),parse_mode="Markdown")
    try:
        reply=await ai_once(f"Write professional email about: {topic}\nInclude: Subject, greeting, body, closing. Same language.")
...
async def post_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not check_limit(user.id,"post",limits["post"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    topic=" ".join(ctx.args)
    if not topic: await update.message.reply_text(t(lang,"ex_post"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"writing_post"),parse_mode="Markdown")
    try:
...
async def biznes_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not check_limit(user.id,"biznes",limits["biznes"]):
        await update.message.reply_text(t(lang,"limit_reached"),parse_mode="Markdown"); return
    idea=" ".join(ctx.args)
    if not idea: await update.message.reply_text(t(lang,"ex_biznes"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"writing_biz"),parse_mode="Markdown")
    try:
        reply=await ai_once(f"Write comprehensive business plan for: {idea}\nExecutive Summary, Market Analysis, Products, Marketing, Financial Projections.")
...
async def admin_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"📋 *Commands:*\n"
        f"`/users` — All users\n"
        f"`/find [id or @user]` — Find user\n"
        f"`/broadcast [text]` — Message all\n"
        f"`/createpromo [type] [val] [uses] [code?]`\n"
        f"`/addcoins [user_id] [amount]`",parse_mode="Markdown")
...
async def payment_success(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if payload=="std_stars":
        ...
        await update.message.reply_text("✅ *Group mode purchased!*\n\nAdd bot to group → send /activate\\_group",parse_mode="Markdown")
...
async def callback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("lang_"):
        ...
        lca=u["language_changed_at"]
        if lca and datetime.now()-lca<timedelta(hours=24):
            await q.answer(t(lang,"lang_cooldown"),show_alert=True); return
        set_language(uid,nl)
        ...
        if u["coins"]>=COINS_STANDARD:
            ...
            await q.message.edit_text(t(lang,"coins_ok_std"),parse_mode="Markdown")
        else: await q.answer(t(lang,"not_enough",need=COINS_STANDARD-u["coins"]),show_alert=True)
        ...
        if u["coins"]>=COINS_PREMIUM:
            ...
            await q.message.edit_text(t(lang,"coins_ok_prm"),parse_mode="Markdown")
        else: await q.answer(t(lang,"not_enough",need=COINS_PREMIUM-u["coins"]),show_alert=True)

    elif data=="card_std":
        kb=[[InlineKeyboardButton(t(lang,"btn_contact"),url=f"https://t.me/{ADMIN_USERNAME}")]]
        await q.message.reply_text(t(lang,"pay_card",card=CARD_NUMBER,amt=USDT_STANDARD,admin=ADMIN_USERNAME),
            reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown")
    elif data=="card_prm":
        kb=[[InlineKeyboardButton(t(lang,"btn_contact"),url=f"https://t.me/{ADMIN_USERNAME}")]]
        await q.message.reply_text(t(lang,"pay_card",card=CARD_NUMBER,amt=USDT_PREMIUM,admin=ADMIN_USERNAME),
            reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown")
        ...
        if u["referral_count"]>=10 and not u["claimed_standard"]:
            ...
            conn.commit(); conn.close()
            await q.message.edit_text(t(lang,"claimed_std"),parse_mode="Markdown")
        else: await q.answer(t(lang,"claim_err"),show_alert=True)
        ...
        if u["referral_count"]>=30 and not u["claimed_premium"]:
            ...
            conn.commit(); conn.close()
            await q.message.edit_text(t(lang,"claimed_prm"),parse_mode="Markdown")
        else: await q.answer(t(lang,"claim_err"),show_alert=True)

    elif data.startswith("ap_free_") or data.startswith("ap_std_") or data.startswith("ap_prm_"):
        parts=data.split("_"); plan_map={"free":"free","std":"standard","prm":"premium"}
        plan_key=parts[1]; tid=int(parts[2])
        plan=plan_map[plan_key]; days=30 if plan!="free" else None
        set_plan(tid,plan,days)
        pem={"free":"🆓","standard":"⭐","premium":"💎"}
        await q.message.edit_text(f"✅ `{tid}` → {pem[plan]} *{plan.upper()}*",parse_mode="Markdown")
        try: await ctx.bot.send_message(tid,f"{pem[plan]} Plan updated to *{plan.upper()}*!",parse_mode="Markdown")
        except: pass
...
async def handle_text(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if u["is_blocked"]:
        await update.message.reply_text(t(lang,"blocked",admin=ADMIN_USERNAME),parse_mode="Markdown"); return

    if is_bad(text):
        wc=add_warning(user.id)
        if wc>=MAX_WARNINGS:
            set_blocked(user.id,True)
            await update.message.reply_text(t(lang,"banned"),parse_mode="Markdown")
        else:
            await update.message.reply_text(t(lang,"warning",c=wc,m=MAX_WARNINGS),parse_mode="Markdown")
        return

    limits=get_limits(u["plan"],u["is_admin"])
    if not u["is_admin"] and not check_limit(user.id,"chat",limits["chat"]):
        kb=[[InlineKeyboardButton(t(lang,"btn_ustd"),callback_data="card_std")]]
        await update.message.reply_text(t(lang,"limit_reached"),reply_markup=InlineKeyboardMarkup(kb),parse_mode="Markdown"); return
    ...
    if total==100000 and not u["achievement_100k"] and not u["is_admin"]:
        ...
        await update.message.reply_text(t(lang,"achievement"),parse_mode="Markdown")
...
async def handle_voice(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        with open("v.ogg","rb") as fp:
            tr=groq_client.audio.transcriptions.create(file=("v.ogg",fp.read()),model="whisper-large-v3")
        text=tr.text
        await update.message.reply_text(t(lang,"you_said")+text,parse_mode="Markdown")
...
async def handle_document(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not doc.file_name.lower().endswith(".pdf"):
        await update.message.reply_text(t(lang,"pdf_only"),parse_mode="Markdown"); return
    await update.message.reply_text(t(lang,"reading_pdf"),parse_mode="Markdown")
    await ctx.bot.send_chat_action(chat_id=update.effective_chat.id,action="typing")
    try:
